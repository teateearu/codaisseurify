...
artist5 = Artist.create( name: "Michael Buble", alive: true, remote_image_url: "http://res.cloudinary.com/teateearu/image/upload/c_fill,g_face,h_200,w_200/v1510492863/michaelbuble_vjx15y.jpg" )
artist6 = Artist.create( name: "Kenny G", alive: true, remote_image_url: "http://res.cloudinary.com/teateearu/image/upload/c_fill,g_west,h_200,w_200/v1510493358/maxresdefault_gocceg.jpg" )
